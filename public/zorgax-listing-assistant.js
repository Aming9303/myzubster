(() => {
  ...
  const categoryHints = {
    ...
    knowledge: ['Che conoscenza, guida o metodo vuoi condividere?', 'Spiega a chi è utile e come verificarlo.', 'Aggiungi una fonte pubblica quando disponibile.'],
  ...
  const detectSuggestedCategory = text => {
    ...
    const rules = [
      ...
      ['knowledge', /\b(conoscenz|know[- ]?how|guida|tutorial|metodo|manuale|competenza|sapere pratico)\b/i],
